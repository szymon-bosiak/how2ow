export const heroDetailsData: Record<
  string,
  { thumbnail: { sm: string; md: string; lg: string }; tips: string[] }
> = {
  ana: {
    thumbnail: {
    ...
    tips: [
      "Do not throw both abilities at the beggining of each fight, it leaves you more volnerable.",
      "Use biotic granade on targets that are most valuable at the moment. It can be for example Mauga that is feeding on your tank in a fight, or your Orisa that is about to die, you need to reaload, and second healer is not kkeping up with the heals.",
    ],
  },
  ashe: {
    thumbnail: {
    ...
    tips: [
      "Practice your aim. Yup, simple as that.",
      "Dynamite is great for building up your Ultimate, but keep it in mind that it also feeds enemie's support Ults.",
    ],
  },
  baptiste: {
    thumbnail: {
    ...
    tips: [
      "Do not focus only on healing, practice spliting between healing and dealing damage. Dooing it well does not impact heling output.",
    ],
  },
  bastion: {
    thumbnail: {
    ...
    tips: [
      "Try not to ult heroes that have movement abilities, they will most likely escape the damege. Instead you can force enemies out of their position.",
    ],
  },
  brigitte: {
    thumbnail: {
    ...
    tips: [
      "Inspire lasts for 4s",
      "Try not to use your abilities ot one just to keep Inspire up.",
      "Inspire AoE is about twice the size of Lucio's.",
    ],
  },
  cassidy: {
    thumbnail: {
    ...
    tips: [
      "Do not throw your flash at random, try to keep the cooldown on somoeone that tries to flank, run away or has fast movement.",
      "His damage fall off is high, so try to play him as close to mid range hero.",
      "His Ultimate is quite long, do not be affraid to hold it for longer to scare away enemy team.",
    ],
  },
  dva: {
    thumbnail: {
    ...
    tips: [
      "Matrix is very powerfull, try to use it on enemy's cooldownas such as ana's biotic granades or event to neutralize Ultimates such as Reaper's death blossom.",
      "With that great of mobility you do not want to be too static, roam around objective and hunt for isolated targets.",
    ],
  },
  doomfist: {
    thumbnail: {
    ...
    tips: [
      "Do not engage on enemy team wtih all their cooldowns, learn to bait ablilities and soft engage.",
      "Learn what characters are worth copying.",
    ],
  },
  echo: {
    thumbnail: {
    ...
    tips: [
      "Use your Ultimate as your second life, it regenerates all your HP.",
    ],
  },
  genji: {
    thumbnail: {
    ...
    tips: [
      "Do not use your Ultimate on enemy team with all abilities up, try to use it when their team is already distracted.",
      "Deflect is most useful briefly after you use it, after that you can cancel this ability to make more pressure.",
      "Practice both shuriken throwing patterns, burst is intended for long range, and fan for short range.",
      'Spam "I need healing" as often as you can.',
    ],
  },
  hanzo: {
    thumbnail: {
    ...
    tips: [
      "Practice your aiming. Do not stress the shot.",
      "Use sonic arrow constantly.",
      "Use storm arrows as individual arrows, do not try to spam them and count on luck.",
  ...
  illari: {
    ...
    tips: [
      "Do not forget that the pylon is not the only source of healing.",
      "Do not let the healing gauge deplete, you will not be able to use haling until it fully reacharges, instead try to always keep a small percentage in.",
      "Wait for the weapon charge to reach full charge, the damage difference is substantial.",
    ],
  },
  "junker-queen": {
    thumbnail: {
    ...
    tips: [
      "Use jagged blade on targets that you know you will hit, stop going for crazy trickshots.",
      "Apply pressure and force out enemy's cooldowns.",
      "Carefully pick the timing of your Ultimate, it is one of the easiest Ults to cancel.",
    ],
  },
  junkrat: {
    thumbnail: {
    ...
    tips: [
      "Keep one mine on hand, it is your get away ability or a way to finish off targets.",
    ],
  },
  juno: {
    thumbnail: {
    ...
    tips: [
      "Do not forget to use hyper ring, similary to Lucio's speed boost it makes your teammates move faster, therefore it is harder to hit them, and easier to close the gaps. While teamfight throw it around teammates, whenever you have it.",
      "Do not use pulsar torpedoes before fight, the are more effective later in when enemy team is not on full HP and your team needs ehaling.",
    ],
  },
  kiriko: {
    thumbnail: {
    ...
    tips: [
      "Swift step is your personal protection suzu, it can cleanse your from every status effect.",
      "Try not to use swift step on isolated teammates that are about to die, most likely it will end up with both of you dead.",
      "Swift step is your way out of danger, so use it wisely.",
      "Protection suzu can cancel a lot os abilities, try to not waste it for situations where you can heal teammates just with ofuda.",
      "Combine dealing damage with healing. Throwing one kunai between ofuda does not affect healing output (throwing two kunais lowers healing output very slightly).",
    ],
  },
  lifeweaver: {
    thumbnail: {
  ...
  lucio: {
    ...
    tips: [
      "Use amp it up when engaging a fight, espaping form ults or if you want to go fast.",
      "Your job is not to heal your teammates fully, you are providing constant AoE heal.",
    ],
  },
  mauga: {
    thumbnail: {
    ...
    tips: ["Please do not play this hero :)"],
  },
  mei: {
    thumbnail: {
    ...
    tips: [
      "Remember to destroy your wall when it does not serve a purpose any longer, it can help enemy team istead.",
    ],
  },
  mercy: {
    thumbnail: {
    ...
    tips: ["Try not to pocket one teammate, others need healing too."],
  },
  moira: {
    thumbnail: {
    ...
    tips: [
      "As a support remember to provide healing for your team. Find a middleground between dealing damage and healing.",
    ],
  },
  orisa: {
    thumbnail: {
    ...
    tips: [
      "Learn how to effectively cycle through your abilities to stay alive.",
      "Javelin can cancel plenty of abilities, and even Ults sucha as Cassiy's deadeye.",
      "Javelin pushes enemies on hit, you can use it to tour advantage.",
    ],
  },
  pharah: {
    thumbnail: {
    ...
    tips: [
      "Beeing always in the air makes you a easy target for any hit scan hero, try peeking through corners, taking high grounds and deal damage that way.",
    ],
  },
  ramattra: {
    thumbnail: {
    ...
    tips: [
      "Blocking while in nemesis form grants you +75% damage reduction, use it more often it can save you form Ultimates.",
    ],
  },
  reaper: {
    thumbnail: {
    ...
    tips: [
      "Do not be obvious with intention of using death blossom. Try hiding, going behind enemy lines or droping from above.",
      "Wraith form automaticly reloads your guns, you can enter and leve it immediately just for that.",
      "Death blossom automaticly reloads your guns.",
      "Keep shadow step for situations that require geting behind enemy team or going back to your teammates.",
    ],
  },
  reinhardt: {
    thumbnail: {
    ...
    tips: [
      "Stop holding your shield all the time, use your HP. Taht way you supports will build their ultimates faster.",
      "Do not yolo charge straight into enemy team.",
      "Keep two fire strikes before using earthshatter, then use both on stunned heroes for easy kills.",
    ],
  },
  roadhog: {
    thumbnail: {
    ...
    tips: [
      "Try not to hook tanks, focus on targets that can be killed after hooking them",
      "You can place pig pen mine close to you before hooking for extra damage and slow.",
      "While hooking look rotate towards hour team or around the corner, hooked target will end up in the direction where you were looking.",
    ],
  },
  sigma: {
    thumbnail: {
    ...
    tips: [
      "Do not use kinetic grasp as last hope after your barrier was destroyed, instead when you see that shield is taking big damage, drop it and use grasp. You will still have barrier, and on top of that gras will grant you aditional shield on top of HP.",
    ],
  },
  sojourn: {
    thumbnail: {
    ...
    tips: [
      "Primary fire IS NOT hit scan, it is projectal, however railgun is a hit scan ability.",
      "Use disruptor shot to block flanks, hallways, highgrounds or on grouped enemies.",
    ],
  },
  "soldier-76": {
    thumbnail: {
    ...
    tips: [
      "Try not to follow your tank to much. Soldier has great flanking potential and can give a lot o vale doing that.",
      "Do no overvalue tactical visor, it should help you for taking out targets like Ulted Mercy. Remember that Ult that killed one hero is better that an Ult that got you killed.",
    ],
  },
  sombra: {
    thumbnail: {
    ...
    tips: [
      "Focus enemy supports, but remember that you are still part of the team and while teamfight is happening you are needed there.",
    ],
  },
  symmetra: {
    thumbnail: {
    ...
    tips: ["Do not be predictable, switch tepelort and turrets positions."],
  },
  torbjorn: {
    thumbnail: {
    ...
    tips: [
      "Use your turret to provide support for your supports, it is not your main way of dealing damage.",
    ],
  },
  tracer: {
    thumbnail: {
    ...
    tips: ["Annoy enemy as much as possible.", "Get used to cooldowns."],
  },
  venture: {
    thumbnail: {
    ...
    tips: ["Focus right targets. They are great for eliminating squishes."],
  },
  widowmaker: {
    thumbnail: {
    ...
    tips: [
      "Practice aiming and positioning.",
      "Try to stay behind and keep grappling hook as an escape.",
      "Well placed shot is better than a few bodyshots.",
    ],
  },
  winston: {
    thumbnail: {
    ...
    tips: [
      "Jumping into enemy defense is not a plan, you have to have some plan befire jumping.",
    ],
  },
  "wrecking-ball": {
    thumbnail: {
    ...
    tips: ["Feel the ball, be the ball."],
  },
  zarya: {
    thumbnail: {
    ...
    tips: [
      "Control your bubble cooldown, and try to be on maximum charge everytime.",
      "Do not be selfish with bubbles, they can potentialy save your teammates.",
    ],
  },
  zenyatta: {
    thumbnail: {
    ...
    tips: [
      "Transcendence has Ultimate canceling potential so do not use it for situations that do not really require it.",
      "While charging orbs you can use mele to cancel it.",
      "Keep in mind that up close you are an easy target.",
    ],
  },
}
